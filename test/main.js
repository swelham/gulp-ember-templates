...
describe('gulp-ember-templates', function () {
  describe('plugin()', function () {
    ...
    it('should output the complied templates with a regex transformed name', function (done) {
    ...
    it('should output the complied templates with a function transformed name', function (done) {
      var expectedContent = readExpectation('simple_amd_function_transformed_name_expectation.js');
      var options = { 
        type: 'amd',
